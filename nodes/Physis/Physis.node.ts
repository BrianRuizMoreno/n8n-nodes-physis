    ...
    description: IExtendedNodeTypeDescription = {
        ...
        properties: [
            ...
            // SILAB
            {
                ...
                options: [
                    { name: 'Campañas', value: 'campania' },
                    { name: 'Actividades', value: 'actividad' },
                    { name: 'Campos', value: 'campo' },
                    { name: 'Lotes', value: 'lote' },
                    { name: 'Labores', value: 'labor' },
                    { name: 'Insumos', value: 'insumo' },
                    { name: 'Implementos', value: 'implemento' },
                    { name: 'Tractores', value: 'tractor' },
                    { name: 'Personal', value: 'personal' },
                    { name: 'Ordenes/Partes', value: 'ordenParte' },
                    { name: 'Ordenes de Trabajo', value: 'ordenTrabajo' }, 
                    { name: 'Estructura Agro', value: 'estructuraAgro' }, 
                    { name: 'Tambos', value: 'tambo' }, 
            ...
            // SIGES
            {
                ...
                options: [
                    ...
                    { name: 'Tipos Varios', value: 'tipo' },
                    { name: 'Chequera', value: 'chequera' },
                    { name: 'Valores', value: 'valor' },
                    { name: 'Informes', value: 'informe' },
                    { name: 'Planes Cuentas', value: 'planCuenta' },
                    { name: 'Planes Cta Auxiliar', value: 'planCuentaAuxiliar' },
                    { name: 'Monedas', value: 'moneda' },
                    { name: 'Tipos Documento', value: 'tipoDocumento' },
                    { name: 'OP Masivo', value: 'opMasivo' },
                    { name: 'Tipos Comprobante', value: 'tipoComprobante' },
                    { name: 'Imágenes', value: 'imagen' },
                    { name: 'Créditos', value: 'credito' },
                    { name: 'Cuentas Auxiliares', value: 'cuentaAuxiliar' },
                    { name: 'Consulta Mayor', value: 'mayor' },
                    { name: 'Medios de Pago', value: 'mediosPago' },
                    { name: 'Cuentas Principales', value: 'cuentaPrincipal' },
                    { name: 'Zonas', value: 'zona' },
            ...
            // SACH
            {
                ...
                options: [
                    { name: 'Categorías', value: 'categoria' },
                    { name: 'Clientes', value: 'cliente' },
                    { name: 'Comisionistas', value: 'comisionista' },
                    { name: 'Entidades', value: 'entidad' },
                    { name: 'Especies', value: 'especie' },
                    { name: 'Establecimientos', value: 'establecimiento' },
                    { name: 'Hacienda', value: 'hacienda' },
                    { name: 'Liquidaciones', value: 'liquidacion' },
                    { name: 'Lotes', value: 'lote' },
                    { name: 'Remates', value: 'remate' },
                ],
                default: 'cliente',
            },
            ...
            // SIFAC
            {
                ...
                options: [
                    ...
                    { name: 'Depósitos', value: 'deposito' },
                    { name: 'Listas Precio', value: 'listaPrecio' },
                    { name: 'Orden Compra', value: 'ordenCompra' },
                    { name: 'Pedidos', value: 'pedido' },
                    { name: 'Productos', value: 'producto' },
                    { name: 'Remitos Compra', value: 'remitoCompra' },
                    { name: 'Transportes', value: 'transporte' },
            ...
            // SAVEC
            {
                ...
                options: [
                    { name: 'Contratos', value: 'contrato' },
                    { name: 'CRM', value: 'crm' },
                    { name: 'Definiciones', value: 'definicion' },
