...
export const reagrupacionRelacionAuxiliarOperations: INodeProperties[] = [
    {
        ...
        options: [
            ...
            { name: 'Listar Disponibles (Árbol)', value: 'getAvailableTree', description: 'GET Cuentas disponibles en formato árbol', action: 'Listar Disponibles (Árbol) a reagrupacion relacion auxiliar',},
            { name: 'Crear Relación', value: 'create', description: 'POST Inserta relación (vincula auxiliar a reagrupación)', action: 'Crear Relación a reagrupacion relacion auxiliar',},
        ],
        default: 'getRelated',
    },
];
