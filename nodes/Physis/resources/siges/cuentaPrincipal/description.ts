...
export const cuentaPrincipalOperations: INodeProperties[] = [
    {
        ...
        options: [
            ...
            { name: 'Listar Árbol', value: 'getArbol', description: 'GET Estructura de árbol', action: 'Listar Árbol a cuenta principal',},
            { name: 'Listar TreeList', value: 'getTreeList', description: 'GET Lista plana para árbol', action: 'Listar TreeList a cuenta principal',},
            { name: 'Listar Depósitos', value: 'getDepositos', description: 'GET Cuentas habilitadas para depósitos', action: 'Listar Depósitos a cuenta principal',},
            ...
            { name: 'Cuentas Reagrupación', value: 'getReagrupacion', description: 'GET Cuentas de reagrupación de una principal', action: 'Cuentas Reagrupación a cuenta principal',},
