...
export const planReagrupacionPrincipalOperations: INodeProperties[] = [
    {
        ...
        options: [
            ...
            { name: 'Listar Árbol', value: 'getArbol', description: 'GET Lista de planes en formato árbol', action: 'Listar Árbol a plan reagrupacion principal',},
            ...
            { name: 'Ver Tamaño Total', value: 'getTamano', description: 'GET Tamaño total de cuentas del plan', action: 'Ver Tamaño Total a plan reagrupacion principal',},
        ],
        default: 'getArbol',
    },
];
