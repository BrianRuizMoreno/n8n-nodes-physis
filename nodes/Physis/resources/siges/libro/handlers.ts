...
export async function execute(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
    ...
    if (operation === 'getAll') endpoint = '/phy2service/api/siges/libros';
    else if (operation === 'getById') endpoint = `/phy2service/api/siges/libros/${id}`;
    else if (operation === 'getByDate') endpoint = `/phy2service/api/siges/libros/${id}`; 
