...
exports.imputacionContableFields = exports.imputacionContableOperations = void 0;
exports.imputacionContableOperations = [
    {
        ...
        options: [
            ...
            { name: 'Listar Regímenes', value: 'getRegimenes', description: 'GET Devuelve una lista de regímenes de imputación', action: 'Listar reg menes an imputacion contable', },
        ],
        default: 'getAll',
    },
];
exports.imputacionContableFields = [
    {
