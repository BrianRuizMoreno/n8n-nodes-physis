...
exports.chequeraFields = exports.chequeraOperations = void 0;
exports.chequeraOperations = [
    {
        ...
        options: [
            ...
            { name: 'Próximo ID', value: 'getNext', description: 'GET Próximo número disponible. Filtros en JSON.', action: 'Pr ximo id a chequera', },
            { name: 'Filtro Electrónico', value: 'getByFiltroElectronico', description: 'GET Chequeras por defecto/electrónicas', action: 'Filtro electr nico a chequera', },
        ],
        default: 'getAll',
    },
];
exports.chequeraFields = [
    {
