...
exports.cuentasTempFields = exports.cuentasTempOperations = void 0;
exports.cuentasTempOperations = [
    {
        ...
        options: [
            {
                ...
                action: 'Iniciar limpiar selecci n a cuentas temp',
            },
            {
            ...
            },
            {
                ...
                action: 'Seleccionar reagrupaci n principal a cuentas temp',
            },
            {
                ...
                action: 'Seleccionar reagrupaci n auxiliar a cuentas temp',
            },
        ],
        default: 'clean',
    },
];
exports.cuentasTempFields = [
    {
